...
import javax.swing.*; // Importação da biblioteca para uso da interface no programa.


public class Main {
    static Cliente clientes = new Cliente();  /* Criamos as instâncias que irão armazenar os objetos criados
    durante o programa. */
    ...
    public static void main(String args[]) {
        menu(); // O main chama somente o menu.
    }
